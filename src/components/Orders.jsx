...
class Orders extends Component {
  ...
  constructor(props) {
    ...
    GSTValue : null,
    // date: date,
    //  finalvalue:this.state.GSTValue +this.state.pkgvalue
 ...
 // const finalvalue = ((this.state.robot.packagefeeIndian + (Plan.packagefeeIndian / 20))*robot.howManyPeoples)
  let pkgvalue= (this.state.robot.packagefeeIndian*this.state.robot.howManyPeoples)
  
 let GSTValue=(this.state.robot.packagefeeIndian*this.state.robot.howManyPeoples*(0.2))
    ...
    <div className="receipt-main col-xs-12 col-sm-12 col-md-12 col-xs-offset-3 col-sm-offset-0 col-md-offset-0">
        ...
        <div className="receipt-header receipt-header-mid">
          <div className="col-xs-12 col-sm-12 col-md-12 ">
            <div className="receipt-right"> 
              <h5 style={{color:"black"}}>{this.state.robot.firstName}  {this.state.robot.lastName}</h5>
              <p>
                <b>Mobile :</b> {this.state.robot.mobileNumber}
              </p>
              <p>
                <b>Email :</b> {this.state.robot.emailId}
              </p>
              <p>
                <b>Date of arrival :</b> {this.state.robot.dateOfCome}
              </p>
              <p>
                <b>Timeslot selected :</b> {this.state.robot.timeSlot}
              </p>
             </div> 
          </div>
      ...
      <div>
        <table className="table table-bordered">
          ...
          <tbody>
            <tr>
              <td className="col-md-9">{this.state.robot.packageName}</td>
              <td className="col-md-3">
                <i className="fa fa-inr" />  {this.state.GSTValue * this.state.robot.howManyPeoples}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                <p>
                  <strong>
                    <i className="fa fa-inr" />{this.state.GSTValue * this.state.robot.howManyPeoples*0.2}
                  </strong>
                </p>
            ...
            <tr>
              ...
              <td className="text-left text-danger">
                <h2>
                  <strong>
                    <i className="fa fa-inr" /> {this.state.GSTValue * this.state.robot.howManyPeoples*0.2+this.state.GSTValue * this.state.robot.howManyPeoples}
                  </strong>
                </h2>
              </td>
            </tr>
